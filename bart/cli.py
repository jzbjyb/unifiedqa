...
def main():
    ...
    parser.add_argument("--steps", default=50000, type=float,
    ...
    print("Using {} gpus".format(args.n_gpu))
    args.world_size = args.n_gpu * 1  # only one node
    os.environ['MASTER_ADDR'] = 'localhost'
    os.environ['MASTER_PORT'] = '12345'
    mp.spawn(run, nprocs=args.n_gpu, args=(args,))
